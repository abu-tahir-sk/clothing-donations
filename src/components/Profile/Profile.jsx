  ...
  return (
    <div className="flex flex-col justify-center items-center py-12 w-11/12 mx-auto bg-cyan-50">
      <div className="card bg-base-100 w-96 shadow-xl  p-8">
            <div >
                  <h2 className="text-3xl font-bold py-4">Welcome back {user?.displayName}</h2>
            </div>
            <div className="flex flex-col justify-center items-center w-32 h-32 mx-auto relative">
                  <img className="w-full h-full rounded-full border-2 border-cyan-200" src={user?.photoURL} alt={user?.displayName} />
            ...
            <div>
                  ...
                  <div className="border-t-2 my-6"></div>
                  <Link to="/updateProfile" className="btn w-full border-none">Update <FaPen></FaPen></Link>
            </div>
